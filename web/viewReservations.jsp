                                ...
                                <%
                                    ...
                                    if (list != null) {
                                        for (Reservation r : list) {
                                            ...
                                            if ("Single".equals(r.getRoomType()))
                                                badge = "bg-info";
                                            else if ("Double".equals(r.getRoomType()))
                                                badge = "bg-warning text-dark";
                                            else if ("Deluxe".equals(r.getRoomType()))
                                                badge = "bg-success";
                                %>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-secondary" href="printBill?id=<%= r.getReservationId()%>">Print</a>
                                    </td>
                                </tr>
                                <%
                                        }
